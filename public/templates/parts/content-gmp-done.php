...
if (isset($_POST['centre_id'])) {
    ...
    $note = isset($_POST['general_note']) ? $_POST['general_note'] : '';

    $gmpplan_obj->update_gmpplan($plan_id, $staff, $note);
}
...
<section class="centre-report gmp">
    <div class="heading-note">
        <p>Continue to the Students Plan</p>
    </div>
    <form method="post" action="<?php echo home_url(); ?>/dashboard/?tab=gross-motor-report&action=student">
    <input type="hidden" name="centre_id" value="<?php echo $centre_id; ?>" />
        ...
        <div class="form-actions">
            ...
            <button class="btn btn-next" type="submit">Continue</button>
        </div>
    </form>
</section>