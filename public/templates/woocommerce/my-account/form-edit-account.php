...
$email = isset($user->user_email) && $user->user_email != '' ? $user->user_email : $user->user_login . '@funfitkidz.com.au';

do_action( 'woocommerce_before_edit_account_form' ); ?>

<form class="woocommerce-EditAccountForm edit-account edit-account-custom" action="" method="post" <?php do_action( 'woocommerce_edit_account_form_tag' ); ?> >
	...
	<input type="hidden" class="woocommerce-Input woocommerce-Input--email input-text" name="account_email" id="account_email" autocomplete="email" value="<?php echo esc_attr( $email ); ?>" />
	<input type="hidden" class="woocommerce-Input woocommerce-Input--email input-text" name="user_login" id="account_user_login" autocomplete="email" value="<?php echo esc_attr( $user->user_login ); ?>" />
	<div class="clear"></div>
